	...
	<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="<?=base_url();?>sachController/index" id="logo"><img src="<?=base_url();?>assets/dest/images/logo-cake.png" width="200px" alt=""></a>
				</div>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						<li><a href="<?=base_url();?>sachController/index">Trang chủ</a></li>
