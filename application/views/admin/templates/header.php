...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
     <script type="text/javascript" src="<?=base_url();?>assets/admin/jquery/script.js"></script>
         <script type="text/javascript" src="<?=base_url();?>assets/admin/bootstrap/js/bootstrap.min.js"></script>         <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.8.1/css/all.css" integrity="sha384-50oBUHEmvpQ+1lW4y57PTFmhCaXp0ML5d60M1M7uH2+nqUivzIebhndOJK28anvf" crossorigin="anonymous"/>
    ...
    <nav class="container-fluid">
      ...
      ?>
        <a class="navbar-brand" href="#">
            ...
            <h4 class="mt-3"><?php echo $_SESSION['full_name'] ?></h4>  
        </a>
